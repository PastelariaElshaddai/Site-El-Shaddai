...
function lerInformacoesConfig(raw){const marker="__ELSHADDAI_CONFIG_V3__";const s=String(raw||"");if(!s.startsWith(marker))return {informacoes:s,tema:temaPadrao()};try{const o=JSON.parse(s.slice(marker.length));return {informacoes:String(o.informacoes||""),tema:{...temaPadrao(),...(o.tema||{})}}}catch(e){return {informacoes:s,tema:temaPadrao()}}}
function salvarInformacoesConfig(informacoes,tema){return "__ELSHADDAI_CONFIG_V3__"+JSON.stringify({informacoes:String(informacoes||""),tema:{...temaPadrao(),...(tema||{})}})}
